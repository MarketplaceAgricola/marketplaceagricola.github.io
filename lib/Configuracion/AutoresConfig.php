<?php
/**
 * Marketplace Agricola - Autores Config
 *
...
class AutoresConfig {
    ...
    const INDICE_DESCRIPCION       = 'Autores de las publicaciones.';    // Descripción para la página índice
    const INDICE_CLAVES            = 'Autores, Personas';                // Claves para la página índice
    ...
    /*  $this->autores[] = new \Base\Autor(
            'nickname', 'titulo', 'nombre completo', 'unknown',
            'empresa o institucion', 'puesto',
            'descripcion',
            'e-mail', 'twitter', 'markdown.md'); */
    } // constructor
